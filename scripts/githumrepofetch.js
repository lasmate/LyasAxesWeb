...
async function fetchRepos() {
  ...
  try {
    ...
    repoList.innerHTML = '<li><div style="background-color: rgb(11,52,79); border-radius: 10px; padding: 10px; margin-bottom: 15px; width:80vw;">Loading repositories...</div></li>';
